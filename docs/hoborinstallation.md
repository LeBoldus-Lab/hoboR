...
Weather station data can turn into big data pretty quickly, logging data every 5
minutes for 3 months generates up to 26,000 records for a single weather station. 
This poses a challenge for manipulation making weather station data  
